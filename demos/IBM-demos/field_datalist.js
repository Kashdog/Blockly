 ...
 */
Blockly.FieldDatalist.FONTSIZE = 11;

/**
 * The HTML input element for the user to type, or null if no FieldDatalist
 * editor is currently open.
 * @type {HTMLInputElement}
 * @private
 */
Blockly.FieldDatalist.htmlInput_ = null;

/**
 * Mouse cursor style when over the hotspot that initiates the editor.
 */
Blockly.FieldDatalist.prototype.CURSOR = 'text';

/**
 * Allow browser to spellcheck this field.
 * @private
 */
Blockly.FieldDatalist.prototype.spellcheck_ = true;

/**
 * Close the input widget if this input is being deleted.
 */
Blockly.FieldDatalist.prototype.dispose = function() {
  Blockly.WidgetDiv.hideIfOwner(this);
  Blockly.FieldDatalist.superClass_.dispose.call(this);
};
 ...
 * @override
 */
Blockly.FieldDatalist.prototype.setValue = function(newValue) {
  if (newValue === null) {
 ...
 */
Blockly.FieldDatalist.prototype.setText = function(newText) {
  if (newText === null) {
    // No change if null.
    return;
  }
 ...
 */
Blockly.FieldDatalist.prototype.setSpellcheck = function(check) {
 ...
 * @private
 */
Blockly.FieldDatalist.prototype.showPromptEditor_ = function() {
  var fieldText = this;
 ...
 * @private
 */
Blockly.FieldDatalist.prototype.showInlineEditor_ = function(quietInput) {
  ...
  var fontSize =
      (Blockly.FieldDatalist.FONTSIZE * this.workspace_.scale) + 'pt';
 ...
 * @private
 */
Blockly.FieldDatalist.prototype.bindEvents_ = function(htmlInput) {
 ...
 * @private
 */
Blockly.FieldDatalist.prototype.unbindEvents_ = function(htmlInput) {
 ...
 * @private
 */
Blockly.FieldDatalist.prototype.onHtmlInputKeyDown_ = function(e) {
  var htmlInput = Blockly.FieldDatalist.htmlInput_;
 ...
 * @private
 */
Blockly.FieldDatalist.prototype.onHtmlInputChange_ = function(
 ...
 * @private
 */
Blockly.FieldDatalist.prototype.validate_ = function() {
  var valid = true;
  goog.asserts.assertObject(Blockly.FieldDatalist.htmlInput_);
  var htmlInput = Blockly.FieldDatalist.htmlInput_;
  if (this.sourceBlock_) {
 ...
 * @private
 */
Blockly.FieldDatalist.prototype.widgetDispose_ = function() {
  var thisField = this;
  return function() {
    var htmlInput = Blockly.FieldDatalist.htmlInput_;
...
Blockly.FieldDatalist.prototype.maybeSaveEdit_ = function() {
  var htmlInput = Blockly.FieldDatalist.htmlInput_;
  // Save the edit (if it validates).
  var text = htmlInput.value;
  if (this.sourceBlock_) {
 ...
 */
Blockly.FieldDatalist.numberValidator = function(text) {
  console.warn('Blockly.FieldDatalist.numberValidator is deprecated. ' +
 ...
 */
Blockly.FieldDatalist.nonnegativeIntegerValidator = function(text) {
  var n = Blockly.FieldDatalist.numberValidator(text);
  if (n) {
